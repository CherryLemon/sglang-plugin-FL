...
def _installed_sglang_version() -> str:
    # The MUSA image can carry stale wheel metadata while importing SGLang
    # directly from its source checkout.  The loaded module is the code whose
    # private profiler interfaces we patch, so its version is authoritative.
    try:
        import sglang
